export const ERROR_MESSAGES = {
  ...
  PROMOTION: {
    ...
    MISSING_BUY_QUANTITY: '[ERROR] 구매 수량이 없습니다.',
    MISSING_GET_QUANTITY: '[ERROR] 증정 수량이 없습니다.',
    MISSING_START_DATE: '[ERROR] 시작 날짜가 없습니다.',
    MISSING_END_DATE: '[ERROR] 종료 날짜가 없습니다.',
    INVALID_BUY_QUANTITY: (value: string) => `[ERROR] 잘못된 구매 수량입니다: ${value}`,
    INVALID_GET_QUANTITY: (value: string) => `[ERROR] 잘못된 증정 수량입니다: ${value}`,
  ...
  INVENTORY: {
    INSUFFICIENT_STOCK: (productName: string, requestedQuantity: number) =>
      `[ERROR] 재고가 부족합니다. 상품: ${productName}, 요청 수량: ${requestedQuantity}`,
  },
  CART: {
    ITEM_NOT_FOUND_IN_CART: (productName: string) =>
      `[ERROR] 장바구니에 없는 상품입니다: ${productName}`,
  },

  STORE: {
    CART_NOT_INITIALIZED: '[ERROR] Cart가 초기화되지 않았습니다.',
    INVENTORY_NOT_INITIALIZED: '[ERROR] Inventory가 초기화되지 않았습니다.',
    CART_OR_INVENTORY_NOT_INITIALIZED: '[ERROR] Cart 또는 Inventory가 초기화되지 않았습니다.',
  },
} as const
